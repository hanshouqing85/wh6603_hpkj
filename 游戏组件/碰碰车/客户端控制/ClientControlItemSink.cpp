...
void __cdecl CClientControlItemSinkDlg::ResetUserBet()
{
	...
	SetDlgItemText(IDC_ST_AREA1,TEXT("保时捷×40:-----"));
	SetDlgItemText(IDC_ST_AREA2,TEXT("宝马×30:-----"));
	SetDlgItemText(IDC_ST_AREA3,TEXT("奔驰×20:-----"));
	SetDlgItemText(IDC_ST_AREA4,TEXT("大众×10:-----"));
	SetDlgItemText(IDC_ST_AREA5,TEXT("保时捷×5:-----"));
	SetDlgItemText(IDC_ST_AREA6,TEXT("宝马×5:-----"));
	SetDlgItemText(IDC_ST_AREA7,TEXT("奔驰×5:-----"));
	SetDlgItemText(IDC_ST_AREA8,TEXT("大众×5:-----"));

	SetDlgItemText(IDC_ST_AREA9, TEXT("保时捷×40:-----"));
	SetDlgItemText(IDC_ST_AREA10,TEXT("宝马×30:-----"));
	SetDlgItemText(IDC_ST_AREA11,TEXT("奔驰×20:-----"));
	SetDlgItemText(IDC_ST_AREA12,TEXT("大众×10:-----"));
	SetDlgItemText(IDC_ST_AREA13,TEXT("保时捷×5:-----"));
	SetDlgItemText(IDC_ST_AREA14,TEXT("宝马×5:-----"));
	SetDlgItemText(IDC_ST_AREA15,TEXT("奔驰×5:-----"));
...
void __cdecl CClientControlItemSinkDlg::SetUserBetScore(BYTE cbArea,SCORE lScore)
{
	...
	switch(cbArea)
	{
	case 0: strPrint.Format(TEXT("保时捷×40:%.2lf"),lScore);break;
	case 1: strPrint.Format(TEXT("宝马×30:%.2lf"),lScore);break;
	case 2: strPrint.Format(TEXT("奔驰×20:%.2lf"),lScore);break;
	case 3: strPrint.Format(TEXT("大众×10:%.2lf"),lScore);break;
	case 4: strPrint.Format(TEXT("保时捷×5:%.2lf"),lScore);break;
	case 5: strPrint.Format(TEXT("宝马×5:%.2lf"),lScore);break;
	case 6: strPrint.Format(TEXT("奔驰×5:%.2lf"),lScore);break;
	case 7: strPrint.Format(TEXT("大众×5:%.2lf"),lScore);break;
...
void __cdecl CClientControlItemSinkDlg::SetAllUserBetScore(BYTE cbArea,SCORE lScore)
{
	...
	switch(cbArea)
	{
	case 0: strPrint.Format(TEXT("保时捷×40:%.2lf"),m_lAllUserBet[cbArea]);break;
	case 1: strPrint.Format(TEXT("宝马×30:%.2lf"),m_lAllUserBet[cbArea]);break;
	case 2: strPrint.Format(TEXT("奔驰×20:%.2lf"),m_lAllUserBet[cbArea]);break;
	case 3: strPrint.Format(TEXT("大众×10:%.2lf"),m_lAllUserBet[cbArea]);break;
	case 4: strPrint.Format(TEXT("保时捷×5:%.2lf"),m_lAllUserBet[cbArea]);break;
	case 5: strPrint.Format(TEXT("宝马×5:%.2lf"),m_lAllUserBet[cbArea]);break;
	case 6: strPrint.Format(TEXT("奔驰×5:%.2lf"),m_lAllUserBet[cbArea]);break;
	case 7: strPrint.Format(TEXT("大众×5:%.2lf"),m_lAllUserBet[cbArea]);break;
