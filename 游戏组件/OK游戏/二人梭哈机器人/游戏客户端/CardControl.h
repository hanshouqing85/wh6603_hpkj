...
public:
	...
	//扑克控制
public:
	void SetIsExtractor(bool bEx) { m_bIsExtractor = bEx;}
	void SetCardIndex(BYTE cbIndex) {m_cbShowIndex = cbIndex;}
	//扑克数目
...
public:
	...
	BYTE GetLeftMouseDownCard(CPoint Point);
};
