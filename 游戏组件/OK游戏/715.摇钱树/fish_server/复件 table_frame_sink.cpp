...
const DWORD kBuildFish18TraceElasped = 63;
const DWORD kBuildFish19TraceElasped = 113;
const DWORD kBuildFish20TraceElasped = 201;
const DWORD kBuildFishLKTraceElasped = 188;
const DWORD kBuildFishBombTraceElasped = 218;
const DWORD kBuildFishSuperBombTraceElasped = 287;
const DWORD kBuildFishLockBombTraceElasped = 124 + 10;
const DWORD kBuildFishSanTraceElasped = 120 + 28;
const DWORD kBuildFishSiTraceElasped = 180 + 17;
...
#ifndef TEST
  if (!server_user_item->IsAndroidUser() && g_stock_score_ < 0) return true;
#endif
...
#ifndef TEST
  if (!server_user_item->IsAndroidUser() && g_stock_score_ - fish_score < 0) return true;
