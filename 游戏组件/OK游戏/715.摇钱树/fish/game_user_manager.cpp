...
bool GameUserManager::UpdateUserItemScore(IGameUserItem* game_user_item, tagUserScore* user_score) {
 ...
 // last_score.lUserMedal = user_info->lUserMedal;
 ...
 // user_info->lUserMedal = user_score->lUserMedal;
