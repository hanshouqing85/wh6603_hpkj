...
bool SoundSetting::Initialize() {
  ...
  sound_setting_->SetBackgroundImage("zyqs\\images\\gui\\setDlg.png");
  ...
  back_music_->SetSelectedImage("zyqs\\images\\gui\\setDlgCheck1.png");
  back_music_->setPosition(38, 106);
  back_music_->setSelected(true);
  sound_setting_->add(back_music_);

  game_sound_ = new fish::CheckBox();
  game_sound_->SetSelectedImage("zyqs\\images\\gui\\setDlgCheck1.png");
  ...
  back_music_slider_->SetSliderImage("zyqs\\images\\gui\\setDlgSlider.png", "zyqs\\images\\gui\\SetDlgPitch.png", "zyqs\\images\\gui\\setDlgThumb.png");
  ...
  game_sound_slider_->SetSliderImage("zyqs\\images\\gui\\setDlgSlider.png", "zyqs\\images\\gui\\SetDlgPitch.png", "zyqs\\images\\gui\\setDlgThumb.png");
