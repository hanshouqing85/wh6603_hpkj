...
protected:
	...
	WORD							m_wDUser;							//D标示
	WORD							m_wSmallBlindUser;					//小盲注标识
	WORD							m_wBigBlindUser;					//大盲注标识
...
protected:
	...
	LONGLONG						m_lEachScore[GAME_PLAYER];			//每次下注
...
protected:
	...
	CPngImageEx						m_ImageBigBlind;					//大盲注位图
	CPngImageEx						m_ImageSmallBlind;					//小盲注位图
	CPngImageEx						m_ImageArrowhead;					//时间箭头
	CPngImageEx						m_ImageCard;						//扑克位图
	CPngImageEx						m_ImageSmallCard;					//小牌位图
	CPngImageEx						m_ImagePass;                        //pass位图
	CPngImageEx						m_ImageAdd;							//add位图
	CPngImageEx						m_ImageFollow;                      //follow位图
	CPngImageEx						m_ImageAllIn;                       //allin位图
...
protected:
	...
	CPoint							m_ptSmallBlind[GAME_PLAYER];		//小盲注的位置
	CPoint							m_ptBigBlind[GAME_PLAYER];			//大盲注的位置
