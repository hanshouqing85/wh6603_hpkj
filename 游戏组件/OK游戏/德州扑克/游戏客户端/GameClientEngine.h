...
protected:
	...
	WORD							m_wDUser;							//D玩家
	WORD							m_wMinChipInUser;					//大盲注
	WORD							m_wMaxChipInUser;					//大盲注
	...
	//加注信息
protected:
	DOUBLE						m_lCellScore;						//单元下注
	DOUBLE						m_lTurnLessScore;					//最小下注
	DOUBLE						m_lTurnMaxScore;					//最大下注
	DOUBLE						m_lAddLessScore;					//加最小注
	DOUBLE						m_lTableScore[GAME_PLAYER];			//下注数目
	DOUBLE						m_lTotalScore[GAME_PLAYER];			//累计下注
	DOUBLE						m_lEachScore[GAME_PLAYER];			//每次下注
	DOUBLE						m_lCenterScore;						//中心筹码
	DOUBLE						m_lBalanceScore;					//平衡筹码

	//状态变量
protected:
	BYTE							m_cbPlayStatus[GAME_PLAYER];		//游戏状态
	BOOL							m_bAutoStart;						//自动开始
	double							m_dEndScore[GAME_PLAYER];			//结束分数//zrh
