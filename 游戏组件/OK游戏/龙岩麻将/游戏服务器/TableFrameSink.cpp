...
#endif
	CString strLog;
	strLog.Format(_T("CMD_S_GameStart 骰子点数lSiceCount=[%d],庄家用户wBankerUser=[%d],当前用户wCurrentUser=[%d],补牌用户wReplaceUser=[%d],圈风cbQuanFeng=[%d],堆立牌头wHeapHead=[%d],堆立牌尾wHeapTail=[%d],花牌麻将cbHuaCardData=[%x]"),GameStart.lSiceCount,GameStart.wBankerUser,GameStart.wCurrentUser,GameStart.wReplaceUser,GameStart.cbQuanFeng,GameStart.wHeapHead,GameStart.wHeapTail,GameStart.cbHuaCardData);
...
#ifdef USE_RS_PRINT
		CString strLog;
		strLog.Format(_T("i=[%d]座,[%x][%x][%x][%x][%x][%x][%x][%x][%x][%x][%x][%x][%x][%x]"),i,GameStart.cbCardData[0],GameStart.cbCardData[1],GameStart.cbCardData[2],GameStart.cbCardData[3],GameStart.cbCardData[4],GameStart.cbCardData[5],GameStart.cbCardData[6],GameStart.cbCardData[7],GameStart.cbCardData[1+7],GameStart.cbCardData[2+7],GameStart.cbCardData[3+7],GameStart.cbCardData[4+7],GameStart.cbCardData[5+7],GameStart.cbCardData[6+7]);
		CTraceService::TraceString(strLog,TraceLevel_Normal);	
		//ofstream outf(g_wcTmp,ios::app); 
		outf<<CT2A(strLog)<<endl;
#endif
...
bool  CTableFrameSink::OnEventGameConclude(WORD wChairID, IServerUserItem * pIServerUserItem, BYTE cbReason)
{
	...
	case GER_NORMAL:		//常规结束
...
#ifdef USE_RS_PRINT
		CString strLog;
		strLog.Format(_T("CMD_S_GameEnd常规结束 供应用户wProvideUser=[%d],供应麻将cbProvideCard=[%x],胡牌类型dwChiHuKind[0,1,2,3]=[%d,%d,%d,%d],胡牌类型dwChiHuRight[0,1,2]=[%d,%d,%d],花牌个数cbHuaCardCount=[%d],总番数cbFanCount=[%d],游戏积分lGameScore[0,1,2,3]=[%lld,%lld,%lld,%lld]"),GameEnd.wProvideUser,GameEnd.cbProvideCard,GameEnd.dwChiHuKind[0],GameEnd.dwChiHuKind[1],GameEnd.dwChiHuKind[2],GameEnd.dwChiHuKind[3],GameEnd.dwChiHuRight[0],GameEnd.dwChiHuRight[1],GameEnd.dwChiHuRight[2],GameEnd.cbHuaCardCount,GameEnd.cbFanCount,GameEnd.lGameScore[0],GameEnd.lGameScore[1],GameEnd.lGameScore[2],GameEnd.lGameScore[3]);
		CTraceService::TraceString(strLog,TraceLevel_Normal);	
		ofstream outf(g_wcTmp,ios::app); 
		outf<<CT2A(strLog)<<endl;
		...
		{
			CString strLog;
			strLog.Format(_T("CMD_S_GameEnd常规结束 i=[%d]座,麻将数目cbCardCount=[%d],[%x][%x][%x][%x][%x][%x][%x][%x][%x][%x][%x][%x][%x][%x]"),i,GameEnd.cbCardCount[i],GameEnd.cbCardData[i][0],GameEnd.cbCardData[i][1],GameEnd.cbCardData[i][2],GameEnd.cbCardData[i][3],GameEnd.cbCardData[i][4],GameEnd.cbCardData[i][5],GameEnd.cbCardData[i][6],GameEnd.cbCardData[i][7],GameEnd.cbCardData[i][1+7],GameEnd.cbCardData[i][2+7],GameEnd.cbCardData[i][3+7],GameEnd.cbCardData[i][4+7],GameEnd.cbCardData[i][5+7],GameEnd.cbCardData[i][6+7]);
			CTraceService::TraceString(strLog,TraceLevel_Normal);	
			//ofstream outf(g_wcTmp,ios::app); 
			outf<<CT2A(strLog)<<endl;
		}
...
///////////////////////
	...
	case GER_DISMISS:		//游戏解散
...
#ifdef USE_RS_PRINT
		CString strLog;
		strLog.Format(_T("CMD_S_GameEnd游戏解散 供应用户wProvideUser=[%d],供应麻将cbProvideCard=[%x],胡牌类型dwChiHuKind[0,1,2,3]=[%d,%d,%d,%d],胡牌类型dwChiHuRight[0,1,2]=[%d,%d,%d],花牌个数cbHuaCardCount=[%d],总番数cbFanCount=[%d],游戏积分lGameScore[0,1,2,3]=[%lld,%lld,%lld,%lld]"),GameEnd.wProvideUser,GameEnd.cbProvideCard,GameEnd.dwChiHuKind[0],GameEnd.dwChiHuKind[1],GameEnd.dwChiHuKind[2],GameEnd.dwChiHuKind[3],GameEnd.dwChiHuRight[0],GameEnd.dwChiHuRight[1],GameEnd.dwChiHuRight[2],GameEnd.cbHuaCardCount,GameEnd.cbFanCount,GameEnd.lGameScore[0],GameEnd.lGameScore[1],GameEnd.lGameScore[2],GameEnd.lGameScore[3]);
		CTraceService::TraceString(strLog,TraceLevel_Normal);	
		ofstream outf(g_wcTmp,ios::app); 
		outf<<CT2A(strLog)<<endl;
		...
		{
			CString strLog;
			strLog.Format(_T("CMD_S_GameEnd游戏解散 i=[%d]座,麻将数目cbCardCount=[%d],[%x][%x][%x][%x][%x][%x][%x][%x][%x][%x][%x][%x][%x][%x]"),i,GameEnd.cbCardCount[i],GameEnd.cbCardData[i][0],GameEnd.cbCardData[i][1],GameEnd.cbCardData[i][2],GameEnd.cbCardData[i][3],GameEnd.cbCardData[i][4],GameEnd.cbCardData[i][5],GameEnd.cbCardData[i][6],GameEnd.cbCardData[i][7],GameEnd.cbCardData[i][1+7],GameEnd.cbCardData[i][2+7],GameEnd.cbCardData[i][3+7],GameEnd.cbCardData[i][4+7],GameEnd.cbCardData[i][5+7],GameEnd.cbCardData[i][6+7]);
			CTraceService::TraceString(strLog,TraceLevel_Normal);	
			//ofstream outf(g_wcTmp,ios::app); 
			outf<<CT2A(strLog)<<endl;
		}
...
#ifdef USE_RS_PRINT
		CString strLog;
		strLog.Format(_T("CMD_S_GameEnd[%d] 供应用户wProvideUser=[%d],供应麻将cbProvideCard=[%x],胡牌类型dwChiHuKind[0,1,2,3]=[%d,%d,%d,%d],胡牌类型dwChiHuRight[0,1,2]=[%d,%d,%d],花牌个数cbHuaCardCount=[%d],总番数cbFanCount=[%d],游戏积分lGameScore[0,1,2,3]=[%lld,%lld,%lld,%lld]"),cbReason,GameEnd.wProvideUser,GameEnd.cbProvideCard,GameEnd.dwChiHuKind[0],GameEnd.dwChiHuKind[1],GameEnd.dwChiHuKind[2],GameEnd.dwChiHuKind[3],GameEnd.dwChiHuRight[0],GameEnd.dwChiHuRight[1],GameEnd.dwChiHuRight[2],GameEnd.cbHuaCardCount,GameEnd.cbFanCount,GameEnd.lGameScore[0],GameEnd.lGameScore[1],GameEnd.lGameScore[2],GameEnd.lGameScore[3]);
		CTraceService::TraceString(strLog,TraceLevel_Normal);	
		ofstream outf(g_wcTmp,ios::app); 
		outf<<CT2A(strLog)<<endl;
...
#ifdef USE_RS_PRINT
		CString strLog;
		strLog.Format(_T("CMD_S_StatusFree 庄家用户wBankerUser=[%d],基础金币lCellScore=[%lld],是否托管bTrustee[0,1,2,3]=[%d,%d,%d,%d]"),StatusFree.wBankerUser,StatusFree.lCellScore,StatusFree.bTrustee[0],StatusFree.bTrustee[1],StatusFree.bTrustee[2],StatusFree.bTrustee[3]);
		CTraceService::TraceString(strLog,TraceLevel_Normal);	
		ofstream outf(g_wcTmp,ios::app); 
		outf<<CT2A(strLog)<<endl;
#endif
...
#ifdef USE_RS_PRINT
		CString strLog;
		strLog.Format(_T("CMD_S_StatusPlay 庄家用户wBankerUser=[%d],单元积分lCellScore=[%lld],是否托管bTrustee[0,1,2,3]=[%d,%d,%d,%d],当前用户wCurrentUser=[%d]"),StatusPlay.wBankerUser,StatusPlay.lCellScore,StatusPlay.bTrustee[0],StatusPlay.bTrustee[1],StatusPlay.bTrustee[2],StatusPlay.bTrustee[3],StatusPlay.wReplaceUser);
		CTraceService::TraceString(strLog,TraceLevel_Normal);	
		ofstream outf(g_wcTmp,ios::app); 
		outf<<CT2A(strLog)<<endl;
#endif
...
#ifdef USE_RS_PRINT
		CString strLog;
		strLog.Format(_T("CMD_C_OutCard 麻将数据cbCardData=[%x]"),pOutCard->cbCardData);
		CTraceService::TraceString(strLog,TraceLevel_Normal);	
		ofstream outf(g_wcTmp,ios::app); 
		outf<<CT2A(strLog)<<endl;
#endif
...
#ifdef USE_RS_PRINT
		CString strLog;
		strLog.Format(_T("CMD_C_OperateCard 操作代码cbOperateCode=[%d],操作麻将cbOperateCard=[%x,%x,%x]"),pOperateCard->cbOperateCode,pOperateCard->cbOperateCard[0],pOperateCard->cbOperateCard[1],pOperateCard->cbOperateCard[2]);
		CTraceService::TraceString(strLog,TraceLevel_Normal);	
		ofstream outf(g_wcTmp,ios::app); 
		outf<<CT2A(strLog)<<endl;
#endif
...
#ifdef USE_RS_PRINT
		CString strLog;
		strLog.Format(_T("CMD_C_ReplaceCard wChairID=[%d],麻将数据cbCardData=[%x]"),wChairID,pReplaceCard->cbCardData);
		CTraceService::TraceString(strLog,TraceLevel_Normal);	
		ofstream outf(g_wcTmp,ios::app); 
		outf<<CT2A(strLog)<<endl;
#endif
...
#ifdef USE_RS_PRINT
		CString strLog;
		strLog.Format(_T("CMD_C_Trustee 托管用户wChairID=[%d],是否托管bTrustee=[%d]"),Trustee.wChairID,Trustee.bTrustee);
		CTraceService::TraceString(strLog,TraceLevel_Normal);	
		ofstream outf(g_wcTmp,ios::app); 
		outf<<CT2A(strLog)<<endl;
#endif
...
#ifdef USE_RS_PRINT
		CString strLog;
		strLog.Format(_T("CMD_C_Listen wChairID=[%d],听牌用户cbListen=[%d]"),pIServerUserItem->GetChairID(),pListen->cbListen);
		CTraceService::TraceString(strLog,TraceLevel_Normal);	
		ofstream outf(g_wcTmp,ios::app); 
		outf<<CT2A(strLog)<<endl;
#endif
...
#ifdef USE_RS_PRINT
		CString strLog;
		strLog.Format(_T("CMD_S_Trustee 托管用户wChairId=[%d],是否托管bTrustee=[%d]"),Trustee.wChairID,Trustee.bTrustee);
		CTraceService::TraceString(strLog,TraceLevel_Normal);	
		ofstream outf(g_wcTmp,ios::app); 
		outf<<CT2A(strLog)<<endl;
#endif
...
#ifdef USE_RS_PRINT
		CString strLog;
		strLog.Format(_T("CMD_S_Listen 听牌用户wChairId=[%d]"),ListenCard.wChairId);
		CTraceService::TraceString(strLog,TraceLevel_Normal);	
		ofstream outf(g_wcTmp,ios::app); 
...
#ifdef USE_RS_PRINT
		CString strLog;
		strLog.Format(_T("CMD_S_OutCard 出牌用户wOutCardUser=[%d],出牌麻将cbOutCardData=[%x]"),OutCard.wOutCardUser,OutCard.cbOutCardData);
		CTraceService::TraceString(strLog,TraceLevel_Normal);	
		ofstream outf(g_wcTmp,ios::app); 
		outf<<CT2A(strLog)<<endl;
#endif
...
#ifdef USE_RS_PRINT
		CString strLog;
		strLog.Format(_T("CMD_S_OperateResult 操作用户wOperateUser=[%d],供应用户wProvideUser=[%d],操作代码cbOperateCode=[%d],操作麻将cbOperateCard[0]=[%x]"),OperateResult.wOperateUser,OperateResult.wProvideUser,OperateResult.cbOperateCode,OperateResult.cbOperateCard[0]);
		CTraceService::TraceString(strLog,TraceLevel_Normal);	
		ofstream outf(g_wcTmp,ios::app); 
		outf<<CT2A(strLog)<<endl;
#endif
...
#ifdef USE_RS_PRINT
		CString strLog;
		strLog.Format(_T("CMD_S_OperateResult杠牌操作 操作用户wOperateUser=[%d],供应用户wProvideUser=[%d],操作代码cbOperateCode=[%d],操作麻将cbOperateCard[0]=[%x]"),OperateResult.wOperateUser,OperateResult.wProvideUser,OperateResult.cbOperateCode,OperateResult.cbOperateCard[0]);
		CTraceService::TraceString(strLog,TraceLevel_Normal);	
		ofstream outf(g_wcTmp,ios::app); 
		outf<<CT2A(strLog)<<endl;
#endif
...
#ifdef USE_RS_PRINT
	CString strLog;
	strLog.Format(_T("CMD_S_ReplaceCard wChairID=[%d]座,补牌用户wReplaceUser=[%d],补牌麻将cbReplaceCard=[%x]"),wChairID,ReplaceCard.wReplaceUser,ReplaceCard.cbReplaceCard);
	CTraceService::TraceString(strLog,TraceLevel_Normal);	
	ofstream outf(g_wcTmp,ios::app); 
	outf<<CT2A(strLog)<<endl;
#endif
...
#ifdef USE_RS_PRINT
		CString strLog;
		strLog.Format(_T("CMD_S_OperateNotify i=[%d]座,还原用户wResumeUser=[%d],动作扑克cbActionCard=[%x],动作掩码cbActionMask=[%d]"),i,OperateNotify.wResumeUser,OperateNotify.cbActionCard,OperateNotify.cbActionMask);
		CTraceService::TraceString(strLog,TraceLevel_Normal);	
		ofstream outf(g_wcTmp,ios::app); 
		outf<<CT2A(strLog)<<endl;
#endif
...
#ifdef USE_RS_PRINT
		CString strLog;
		strLog.Format(_T("CMD_S_SendCard 当前用户wCurrentUser=[%d],发牌用户wSendCardUser=[%d],末尾发牌bTail=[%d],补牌用户wReplaceUser=[%d],动作掩码cbActionMask=[%d],麻将数据cbCardData=[%x],花牌麻将cbHuaCardData=[%x]"),SendCard.wCurrentUser,SendCard.wSendCardUser,bTail,SendCard.wReplaceUser,SendCard.cbActionMask,SendCard.cbCardData,SendCard.cbHuaCardData);
		CTraceService::TraceString(strLog,TraceLevel_Normal);	
		ofstream outf(g_wcTmp,ios::app); 
		outf<<CT2A(strLog)<<endl;
#endif
