...
protected:
	...
	CBitImage						m_ImageBirdBack;					//鸟图背景
	CBitImage						m_ImageHuangZhuang;					//荒庄标志
	CBitImage						m_ImageGold;						//金B位置
	CBitImage						m_BackGround;						//底色
	CBitImage						m_ImageChuiFlag;					//捶牌图案
	CBitImage						m_ImageGoldCard;					//金牌背景
...
private:
	...
	void  SetImageGold( CDC *pDC, BYTE byPlayer, IClientUserItem* pUserData );
