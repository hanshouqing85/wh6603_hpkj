...
BYTE const CGameLogic::m_cbCardDataArray[MAX_REPERTORY]=
{
	...
	0x41,0x42,0x43,0x44,0x45,0x46,0x47,0x48								//春夏秋冬梅兰菊竹(index = 34~41)
#endif
};
...
{
    m_cbMagicIndex=MAX_INDEX;//by hxh
}
