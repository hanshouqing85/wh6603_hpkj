...
#define GS_MJ_BEFOREPLAY			(GAME_STATUS_PLAY+1)						//游戏前状态
...
//留牌张数
#define	MAX_LEFT_COUNT				13//16									//留牌张数
...
{	
	WORD							wBankerUser;						//庄家用户
	WORD							wCurrentUser;						//当前用户	
	BYTE							cbCardData[MAX_LEFT_COUNT+1];		//麻将列表
};
...
struct CMD_S_GameEnd
{
	...
	BYTE							cbCardData[4][MAX_LEFT_COUNT+1];	//麻将数据
	char							strEnd[100];
	int								lGameTax;
	bool							mbChui[4];							//捶牌用户
