...
public:
	...
	// eng: Initialization
	// rus: Инициализация
	void Initialization(int axis, MP_Platform* platform, int interpolation, int loop, int position_mode, int atlas_width=1024, int atlas_height=1024, int atlas_frame_step=1, float atlas_starting_scale=1.f, float atlas_scale_step=0.1f, bool copy_mode=true);
