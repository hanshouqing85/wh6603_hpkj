...
VOID CScoreControl::OnEventDrawWindow(CD3DDevice * pD3DDevice, INT nXOriginPos, INT nYOriginPos)
{
	...
	CSize SizeChunTian;
	SizeBombNumber.SetSize(m_TextureBombNumber.GetWidth()/12L,m_TextureBombNumber.GetHeight());
	...
	for (WORD i=0;i<GAME_PLAYER;i++)
	{
		...
		//炸弹信息
		INT nBombExcursion=SizeBombNumber.cx*(m_ScoreInfo.cbEachBombCount[i]+2);
		m_TextureBombNumber.DrawImage(pD3DDevice,nXOriginPos+302,nYOriginPos+73+i*81,SizeBombNumber.cx,SizeBombNumber.cy,SizeBombNumber.cx,0);
