...
#ifdef USE_GB
	////lstrcpyn(m_GameServiceAttrib.szDescription,TEXT("CT麻将游戏服务组件"),CountArray(m_GameServiceAttrib.szDescription));
#ifndef VIDEO_GAME
...
#endif
#else
//	lstrcpyn(m_GameServiceAttrib.sz,TEXT("杭州麻将游戏服务组件"),CountArray(m_GameServiceAttrib.szDescription));
#ifndef VIDEO_GAME
