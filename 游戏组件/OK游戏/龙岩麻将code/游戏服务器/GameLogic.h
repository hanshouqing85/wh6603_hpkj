...
#define CHR_PENG_PENG				0x00000002								//对对胡
#define CHR_HUN_YI_SE				0x00000004								//混一色
#define CHR_QING_YI_SE				0x00000008								//清一色
#define CHR_ZI_YI_SE				0x00000010								//字一色
#define CHR_ZI_MO					0x00000020								//自摸
#define CHR_KAN_ZHANG				0x00000040								//夹中胡
...
//////////////////////////////////////////////////////////////////////////	
//调试函数
static void MyMsgBox(LPCTSTR lpszFormat, ...)
{
	va_list args;
	int		nBuf;
	TCHAR	szBuffer[512];
...
static void MyDebug(LPCTSTR lpszFormat, ...)
{
	va_list args;
	int		nBuf;
	TCHAR	szBuffer[512];
...
public:
	...
	//吃胡分析
	BYTE AnalyseChiHuCard(const BYTE cbCardIndex[MAX_INDEX], const tagWeaveItem WeaveItem[], BYTE cbWeaveCount, BYTE cbCurrentCard, CChiHuRight &ChiHuRight,BYTE &cbHu,bool bZimo=false);
	//听牌分析
...
protected:
	...
	//字一色
	bool IsZiYiSe( const tagAnalyseItem &pAnalyseItem );
	//清一色牌
