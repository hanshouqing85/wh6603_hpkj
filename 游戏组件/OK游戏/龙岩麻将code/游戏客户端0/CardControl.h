...
public:
	//获取位置
	inline int GetImageIndex(BYTE cbCardData,bool bCaiChen=true);
	//绘画扑克
	inline bool DrawCardItem(CDC * pDestDC, BYTE cbCardData, int xDest, int yDest, bool bShadow,bool bCaiChen=true);
};
...
public:
	...
	//添加扑克
	bool AddCardData(WORD wCardCount);
	//获取牌数
...
extern BYTE							g_cbChangeCard;						//财神扑克
