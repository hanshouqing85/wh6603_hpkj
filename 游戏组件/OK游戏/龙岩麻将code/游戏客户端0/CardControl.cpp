...
//获取位置
int CCardListImage::GetImageIndex(BYTE cbCardData,bool bCaiChen)
{
	//背景判断
	if (cbCardData==0) 
		return 0;
...
//绘画扑克
bool CCardListImage::DrawCardItem(CDC * pDestDC, BYTE cbCardData, int xDest, int yDest, bool bShadow,bool bCaiChen)
{
	//效验状态
	...
	if(cbCardData<=0x37)
	{
		int nImageXPos=GetImageIndex(cbCardData,bCaiChen)*m_nItemWidth;
		//绘画阴影
		if( bShadow )
		...
		if(0x37==cbCardData)
		{
			//创建字体
			CFont ViewFont;
			ViewFont.CreateFont(-11,0,0,0,300,0,0,0,134,3,2,1,2,TEXT("宋体"));
			CFont *pOldFont=pDestDC->SelectObject(&ViewFont);
			pDestDC->SetTextColor(RGB(255,0,0));
			pDestDC->TextOut(xDest+2,yDest+1,TEXT("财"));
			//删除资源
			pDestDC->SelectObject(pOldFont);
			...
			if ((m_wFullCount-m_wMinusHeadCount-m_wMinusLastCount)>0)
			{
				...
				if (m_wMinusLastCount%2!=0)
				{
					...
					if( m_cbCardData[wCardIndex+1] != 0 )
					{
						if( m_cbCardData[wCardIndex+1] != 255 )
							g_CardResource.m_ImageTableLeft.DrawCardItem( pDC,m_cbCardData[wCardIndex+1],nXPos,nYPos+10,true ,false);
					}
					else
					{
				...
				for (WORD i=wDoubleIndex;i<wFinallyIndex;i++)
				{
					...
					if( m_cbCardData[wCardIndex+1] != 0 || m_cbCardData[wCardIndex] != 0 )
					{
						...
						{
							if( m_cbCardData[wCardIndex+1] != 255 )
								g_CardResource.m_ImageTableLeft.DrawCardItem( pDC,m_cbCardData[wCardIndex+1],nXPos,nYPos+10,false ,false);
						}
						...
						if( m_cbCardData[wCardIndex] != 0 )
						{
							if( m_cbCardData[wCardIndex] != 255 )
								g_CardResource.m_ImageTableLeft.DrawCardItem( pDC,m_cbCardData[wCardIndex],nXPos,nYPos,false ,false);
						}
				...
				if (m_wMinusHeadCount%2!=0)
				{
					...
					{
						if( m_cbCardData[wCardIndex+1] != 255 )
							g_CardResource.m_ImageTableLeft.DrawCardItem( pDC,m_cbCardData[wCardIndex+1],nXPos,nYPos,true ,false);
					}
					else
					{
	...
	case Direction_South:	//南向
		{
			...
			if ((m_wFullCount-m_wMinusHeadCount-m_wMinusLastCount)>0)
			{
				...
				if (m_wMinusLastCount%2!=0)
				{
					...
					{
						if( m_cbCardData[wCardIndex+1] != 255 )
							g_CardResource.m_ImageTableBottom.DrawCardItem( pDC,m_cbCardData[wCardIndex+1],nXPos,nYPos+nYExcusion,true ,false);
					}
					else
					{
				...
				for (WORD i=wDoubleIndex;i<wFinallyIndex;i++)
				{
					...
					if( m_cbCardData[wCardIndex+1] != 0 || m_cbCardData[wCardIndex] != 0 )
					{
						...
						{
							if( m_cbCardData[wCardIndex+1] != 255 )
								g_CardResource.m_ImageTableBottom.DrawCardItem( pDC,m_cbCardData[wCardIndex+1],nXPos,nYPos+nYExcusion,false,false );
						}
						else g_CardResource.m_ImageHeapSingleH.DrawImage( pDC,nXPos,nYPos+nYExcusion );
						if( m_cbCardData[wCardIndex] != 0 )
						{
							if( m_cbCardData[wCardIndex] != 255 )
								g_CardResource.m_ImageTableBottom.DrawCardItem( pDC,m_cbCardData[wCardIndex],nXPos,nYPos,false ,false);
						}
	...
	case Direction_West:	//西向
		{
			...
			if ((m_wFullCount-m_wMinusHeadCount-m_wMinusLastCount)>0)
			{
				...
				if (m_wMinusHeadCount%2!=0)
				{
					...
					{
						if( m_cbCardData[wCardIndex+1] != 255 )
							g_CardResource.m_ImageTableRight.DrawCardItem( pDC,m_cbCardData[wCardIndex+1],nXPos,nYPos+10,true ,false);
					}
					else
					{
						g_CardResource.m_ImageHeapSingleVShadow.DrawImage( pDC,nXPos,nYPos+10 );
				...
				for (WORD i=wDoubleIndex;i<wFinallyIndex;i++)
				{
					...
					if( m_cbCardData[wCardIndex] != 0 || m_cbCardData[wCardIndex+1] != 0 )
					{
						...
						{
							if( m_cbCardData[wCardIndex+1] != 255 )
								g_CardResource.m_ImageTableRight.DrawCardItem( pDC,m_cbCardData[wCardIndex+1],nXPos,nYPos+10,false,false );
						}
						else g_CardResource.m_ImageHeapSingleV.DrawImage( pDC,nXPos,nYPos+10 );
						if( m_cbCardData[wCardIndex] != 0 )
						{
							if( m_cbCardData[wCardIndex] != 255 )
								g_CardResource.m_ImageTableRight.DrawCardItem( pDC,m_cbCardData[wCardIndex],nXPos,nYPos,false ,false);
						}
						else g_CardResource.m_ImageHeapSingleV.DrawImage( pDC,nXPos,nYPos );
					}
					else g_CardResource.m_ImageHeapDoubleV.DrawImage( pDC,nXPos,nYPos );
				...
				if (m_wMinusLastCount%2!=0)
				{
					...
					{
						if( m_cbCardData[wCardIndex+1] != 255 )
							g_CardResource.m_ImageTableRight.DrawCardItem( pDC,m_cbCardData[wCardIndex+1],nXPos,nYPos,true ,false);
					}
					else
					{
						g_CardResource.m_ImageHeapSingleVShadow.DrawImage( pDC,nXPos,nYPos );
	...
	case Direction_North:	//北向
		{
			...
			if ((m_wFullCount-m_wMinusHeadCount-m_wMinusLastCount)>0)
			{
				...
				if (m_wMinusHeadCount%2!=0)
				{
					...
					{
						if( m_cbCardData[wCardIndex+1] != 255 )
							g_CardResource.m_ImageTableTop.DrawCardItem( pDC,m_cbCardData[wCardIndex+1],nXPos,nYPos+nYExcusion,true ,false);
					}
					else
					{
						g_CardResource.m_ImageHeapSingleHShadow.DrawImage( pDC,nXPos,nYPos+nYExcusion );
				...
				for (WORD i=wDoubleIndex;i<wFinallyIndex;i++)
				{
					...
					if( m_cbCardData[wCardIndex+1] != 0 || m_cbCardData[wCardIndex] != 0 )
					{
						...
						{
							if( m_cbCardData[wCardIndex+1] != 255 )
								g_CardResource.m_ImageTableTop.DrawCardItem( pDC,m_cbCardData[wCardIndex+1],nXPos,nYPos+nYExcusion,false,false );
						}
						else g_CardResource.m_ImageHeapSingleH.DrawImage( pDC,nXPos,nYPos+nYExcusion );
						if( m_cbCardData[wCardIndex] != 0 )
						{
							if( m_cbCardData[wCardIndex] != 255 )
								g_CardResource.m_ImageTableTop.DrawCardItem( pDC,m_cbCardData[wCardIndex],nXPos,nYPos,false ,false);
						}
						else g_CardResource.m_ImageHeapSingleH.DrawImage( pDC,nXPos,nYPos );
					}
					else g_CardResource.m_ImageHeapDoubleH.DrawImage( pDC,nXPos,nYPos );
...
//添加扑克
bool CUserCard::AddCardData(WORD wCardCount)
{
	ASSERT( m_wCardCount+(m_bCurrentCard?1:0)+wCardCount <= MAX_COUNT );
	if( m_wCardCount+(m_bCurrentCard?1:0)+wCardCount > MAX_COUNT ) return false;

	if( m_wCardCount < MAX_COUNT-1 )
		m_wCardCount += wCardCount;
	else 
	{
		m_wCardCount = MAX_COUNT-1;
		m_bCurrentCard = true;
	}
...
bool CCardControl::OnEventSetCursor(CPoint Point, CRect &rcRePaint)
{
	...
	else if( m_bSelectMode && m_bPositively )
	{
		...
		if( m_cbCurSelectIndex != cbCurIndex )
		{
			...
			{
				BYTE  i=0;
				for( i = 0; i < m_SelectCardInfo[cbCurIndex].cbCardCount; i++ )
				{
					WORD j=0;
