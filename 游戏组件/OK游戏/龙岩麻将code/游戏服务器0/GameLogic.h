...
//#define WIK_ZI_MO					0x0100								//吃胡类型
#define WIK_XIAO_HU					0x100								//小胡		
#define WIK_MAKE_EYE				0x200								//游
#define WIK_MAKE_EYE_THREE			0x400								//游
//////////////////////////////////////////////////////////////////////////
//胡牌定义
...
*/
//*
#define CHR_NULL					0x00000000									//非胡
#define CHR_GANG_KAI				0x00000001									//杠开
#define CHR_GANG_KAI_MAGIC			0x00000002									//杠暴
#define CHR_MAGIC_HU				0x00000004									//暴头
#define CHR_MAGIC_HU2				0x00000008									//飘花(暴头2)
#define CHR_GANG_MAGIC				0x00000010									//杠暴
#define CHR_MAGIC_GANG				0x00000020									//飘杠
#define CHR_MAGIC_EYE				0x00000040									//财神吊牌
#define	CHR_NO_MAGIC_DADIAO			0x00000080									//无花大调（自摸）
#define	CHR_HU_ZIMO					0x00000100									//无花自摸
#define	CHR_THREE_MAGIC				0x00000200									//三花（翻倍）
#define	CHR_HENG_FAN				0x00000400									//横翻（色子成对，和>=10，上局黄庄，计分*2，但不累加）
#define	CHR_GANG_FAN				0x00000800									//杠有分
#define	CHR_MAGIC_DADIAO			0x00001000									//有花大吊
#define CHR_WU_FAN					0x00002000									//普通胡
#define	CHR_HAS_MAGIC				0x00004000									//赢家有花牌（财神）
#define	CHR_MAGIC_HU3				0x00008000									//多飘花

//#define CHR_QI_DUI					0x20000020									//七对
//#define CHR_QI_DUI1					0x20000010									//七对
//#define CHR_QI_DUI2					0x20000008									//七对
//#define CHR_QI_DUI3					0x20000004									//七对
//////////////////////////////////////////////////////////////////////////
...
public:
	...
	//辅助函数
public:
	// 是否大吊：手上只剩下两张牌（其他都已经成刻字顺子）
	bool IsDaDiao(const BYTE cbCardIndex[MAX_INDEX]);
	//有效判断
...
public:
	...
	//胡牌等级
	WORD GetChiHuActionRank(const CChiHuRight & ChiHuRight,bool bSecondMagic);
...
public:
	...
	//七小对牌
	BYTE IsQiXiaoDui(const BYTE cbCardIndex[MAX_INDEX], const tagWeaveItem WeaveItem[],const  BYTE cbWeaveCount,const BYTE cbCurrentCard);
		//带幺
	...
	BYTE GetHongZhongNum(const BYTE cbCardIndex[MAX_INDEX]);
	//内部函数

public:
	//牌转换为汉字
	CString GetPaiString(BYTE bCard);
};
