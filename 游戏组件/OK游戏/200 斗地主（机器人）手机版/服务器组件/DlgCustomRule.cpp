...
CDlgCustomRule::CDlgCustomRule() : CDialog(IDD_CUSTOM_RULE)
{
	...
	m_CustomRule.cbTimeStartGame = 30;
	m_CustomRule.cbTimeHeadOutCard = 30;
	m_CustomRule.cbTimeRodBanker = 20;
	return;
}
...
BOOL CDlgCustomRule::OnInitDialog()
{
	...
	//((CEdit *)GetDlgItem(IDC_TIME_ADD_DOUBLE))->LimitText(2);
	((CEdit *)GetDlgItem(IDC_TIME_HEAD_OUT_CARD))->LimitText(2);
	((CEdit *)GetDlgItem(IDC_TIME_OUT_CARD))->LimitText(2);
	((CEdit *)GetDlgItem(IDC_TIME_START_GAME))->LimitText(2);
	((CEdit *)GetDlgItem(IDC_TIME_CALL_BANKER))->LimitText(2);
	((CEdit *)GetDlgItem(IDC_TIME_ROD_BANKER))->LimitText(2);
	((CEdit *)GetDlgItem(IDC_FLEE_SCORE_TIMES))->LimitText(2);
...
//	SetDlgItemInt(IDC_TIME_HEAD_OUT_CARD,m_CustomRule.cbTimeHeadOutCard);
	...
	SetDlgItemInt(IDC_TIME_ROD_BANKER,m_CustomRule.cbTimeRodBanker);
	//SetDlgItemInt(IDC_TIME_ADD_DOUBLE,m_CustomRule.cbTimeAddDouble);
	SetDlgItemInt(IDC_TIME_HEAD_OUT_CARD,m_CustomRule.cbTimeHeadOutCard);
	SetDlgItemInt(IDC_TIME_OUT_CARD,m_CustomRule.cbTimeOutCard);
...
bool CDlgCustomRule::FillControlToData()
{
	...
	m_CustomRule.cbTimeRodBanker=(BYTE)GetDlgItemInt(IDC_TIME_ROD_BANKER);
	...
	{
		AfxMessageBox(TEXT("叫地主时间设置范围错误，请重新设置！"),MB_ICONSTOP);
		return false;
	}

	//抢地主时间
	if ((m_CustomRule.cbTimeRodBanker<5)||(m_CustomRule.cbTimeRodBanker>60))
	{
		AfxMessageBox(TEXT("抢地主时间设置范围错误，请重新设置！"),MB_ICONSTOP);
		return false;
	}
