...
#define IDC_CALL_SCORE_NONE			203									//不叫按钮
//叫地主按钮
#define IDC_BT_CALL_BANKER			351                             	//叫地主按钮
#define IDC_BT_ROD_BANKER			353                             	//抢地主按钮
#define IDC_BT_NO_ROD				354                             	//不抢按钮
...
BEGIN_MESSAGE_MAP(CGameClientView, CGameFrameViewD3D)
	...
	ON_BN_CLICKED(IDC_CALL_SCORE_NONE, OnBnClickedNoCallBanker)//不叫

	//叫地主按钮
	ON_BN_CLICKED(IDC_BT_CALL_BANKER, OnBnClickedCallBanker)//叫地主
	ON_BN_CLICKED(IDC_BT_ROD_BANKER, OnBnClickedRodBanker)	//抢地主
	ON_BN_CLICKED(IDC_BT_NO_ROD, OnBnClickedNoRodBanker)	//不抢
...
//	ZeroMemory(m_cbCallScore,sizeof(m_cbCallScore));
	...
	//叫分按钮
	m_btRodBanker.ShowWindow(false);//抢地主
	m_btNoRodBanker.ShowWindow(false);//不抢
...
VOID CGameClientView::RectifyControl(INT nWidth, INT nHeight)
{
	...
	/*	m_btCallScore1.GetClientRect(rcCallButton);
		...
		m_btNoCallBanker.GetClientRect(rcCallButton);//不叫地主按钮
