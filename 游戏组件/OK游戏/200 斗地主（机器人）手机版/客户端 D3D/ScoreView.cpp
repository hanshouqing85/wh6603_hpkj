...
void CScoreView::OnPaint() 
{
	...
	for (WORD i=0;i<CountArray(m_szUserName);i++)
	{
		...
		{
			dc.TextOut(106+10,(int)(wStation*25+85+5),m_szUserName[i]);
			swprintf(szBuffer,sizeof(szBuffer),_T("%I64d"),m_lScore[i]);
			dc.TextOut(232+40,(int)(wStation*25+85+5),szBuffer,lstrlen(szBuffer));
			wStation++;
		}
	}
