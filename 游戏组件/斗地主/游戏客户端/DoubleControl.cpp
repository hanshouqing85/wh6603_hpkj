...
//鼠标事件
BOOL CDoubleControl::OnEventMouse(UINT uMessage, UINT nFlags, INT nXMousePos, INT nYMousePos)
{
	return FALSE;
}

//按钮事件
BOOL CDoubleControl::OnEventButton(UINT uButtonID, UINT uMessage, INT nXMousePos, INT nYMousePos)
{
	return FALSE;
}

//键盘事件
BOOL CDoubleControl::OnEventKeyboard(UINT uMessage, WPARAM wParam, LPARAM lParam)
{
	return FALSE;
}
