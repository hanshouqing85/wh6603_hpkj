...
// 	afx_msg void OnBnClickedBtnLi();
	...
	afx_msg void OnBnClinckedBtnDx();//大小
	afx_msg void OnBnClinckedBtnDsh();	//单双
...
// 	afx_msg void OnRioBaoZi();	//豹子
	...
	afx_msg void OnBnClickedBtnSave();//删除
	afx_msg void OnBnClickedBtnJetton1();//筹码
	afx_msg void OnBnClickedBtnJetton2();//筹码
	afx_msg void OnBnClickedBtnJetton3();//筹码
	afx_msg void OnBnClickedBtnJetton4();//筹码
	afx_msg void OnBnClickedBtnJetton5();//筹码
public:
...
private:
	...
	CTextButton m_btnTextDx;					//大小  
	CTextButton m_btnTextDsh;					//单双  
...
// 	CImgRioButton m_rioBaoZi;					//豹子
	...
	CImageButton m_btnDelSel;	//自定义 按钮
	CImageButton m_btnClsList;	//游戏说明
	...
	bool		m_bShowEdit;
	CSkinEditEx m_editJetton1;		//筹码输入
	CSkinEditEx m_editJetton2;		//筹码输入
	CSkinEditEx m_editJetton3;		//筹码输入
	CSkinEditEx m_editJetton4;		//筹码输入
	CSkinEditEx m_editJetton5;		//筹码输入
