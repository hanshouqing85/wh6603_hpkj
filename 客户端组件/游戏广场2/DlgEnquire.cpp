...
BOOL CDlgEnquire::OnInitDialog()
{
	...
	m_btCloseServer.SetWindowPos(NULL,LAYERED_SIZE+nButtonSpace*3+rcButton.Width()*2-25,182,0,0,SWP_NOZORDER|SWP_NOSIZE|SWP_NOREDRAW);
	m_btSwitchAccounts.SetWindowPos(NULL,LAYERED_SIZE+nButtonSpace*2+rcButton.Width()*1+7,182,0,0,SWP_NOZORDER|SWP_NOSIZE|SWP_NOREDRAW);
	m_btClosePlaza.SetWindowPos(NULL,LAYERED_SIZE+nButtonSpace*1+rcButton.Width()*0+39,182,0,0,SWP_NOZORDER|SWP_NOSIZE|SWP_NOREDRAW);
