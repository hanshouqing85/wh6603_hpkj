...
// 			m_tEnd += CTimeSpan(0, 23, 59, 59);
			...
			if(m_MissionManager!=NULL)
				m_MissionManager->SendData(MDM_GP_USER_SERVICE,SUB_GP_GET_CHONGZHI_LOG_COUNT,&GetChongzhiLogCount,sizeof(GetChongzhiLogCount));
		}
...
// 			}
			...
			if(m_MissionManager!=NULL)
				m_MissionManager->SendData(MDM_GP_USER_SERVICE,SUB_GP_GET_CHONGZHI_LOG,&ChongzhiLog,sizeof(ChongzhiLog));
			return;
		}
