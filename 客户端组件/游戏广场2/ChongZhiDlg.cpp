...
static const int btn_yinhang_y = 240;
static const int btn_space = 140;
static const int bnt_left = 316;
...
//复制账号
static const int btn_cp_zhanghu_y = 298;
//复制开户人
static const int btn_cp_kaihuren_y = 337;
//复制开户银行
static const int btn_cp_yinhang_y = 377;
//复制游戏ID
static const int btn_cp_gameid_y = 417;

//账户信息数据
static const CRect rc_zhanghu(525, 302, 800, 327);
static const CRect rc_kaihuren(525, 338, 800, 374);
static const CRect rc_kaihuhang(525,376, 800, 415);
static const CRect rc_gameid(525, 408, 800, 464);
...
void CChongZhiDlg::OnPaint()
{
	...
	graphics.DrawImage(m_bmpChongZhiBk, Rect(0, 103,   m_bmpChongZhiBk->GetWidth(), m_bmpChongZhiBk->GetHeight()), 
