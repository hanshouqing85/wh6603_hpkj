		...
		case SUB_GR_GET_Peie_RET:
			{
				...
				{
					m_strPeie.Format(L"剩余配额：【3.0】%d个【2.9】%d个 【2.8】%d个 【2.7】%d个 【2.6】%d个",n_peie_1-n_peie_s_1,n_peie_2-n_peie_s_2,n_peie_3-n_peie_s_3,n_peie_4-n_peie_s_4,n_peie_5-n_peie_s_5);
				}
				else if(theAccount.fandian*100 > 2.999999999999 && theAccount.fandian*100 < 3.00000001)
				{
					m_strPeie.Format(L"剩余配额：【2.9】%d个【2.8】%d个 【2.7】%d个 【2.6】%d个",n_peie_2-n_peie_s_2,n_peie_3-n_peie_s_3,n_peie_4-n_peie_s_4,n_peie_5-n_peie_s_5);
				}
				else if(theAccount.fandian*100 > 2.899999999999 && theAccount.fandian*100 < 2.90000001)
				{
					m_strPeie.Format(L"剩余配额：【2.8】%d个 【2.7】%d个 【2.6】%d个",n_peie_3-n_peie_s_3,n_peie_4-n_peie_s_4,n_peie_5-n_peie_s_5);
				}
