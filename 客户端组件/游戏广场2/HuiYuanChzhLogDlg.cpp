...
// 			m_tEnd += CTimeSpan(0, 23, 59, 59);
			...
			if(m_MissionManager!=NULL)
				m_MissionManager->SendData(MDM_GP_USER_SERVICE,SUB_GP_GET_XJCHZH_LOG_COUNT,&GetXJCHZHLogCount,sizeof(GetXJCHZHLogCount));
			return;
		}
...
// 			}
			...
			if(m_MissionManager!=NULL)
				m_MissionManager->SendData(MDM_GP_USER_SERVICE,SUB_GP_GET_XJCHZH_LOG,&GetXJCHZHLog,sizeof(GetXJCHZHLog));
