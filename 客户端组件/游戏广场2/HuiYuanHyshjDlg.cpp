		...
		case SUB_GR_GET_HYSHJ_RET:
			{
				...
				m_xiajirenshu.Format(_T("%d人"), pCountRet->n_t_xjrs);
				m_zaixianrenshu.Format(_T("%d人"), pCountRet->n_t_xjzx);
				...
				m_xinchongzhi.Format(_T("%d人"),pCountRet->n_t_newchongzhi);
				m_jinrizhuce.Format(_T("%d人"),pCountRet->n_t_jinrizhuce);
