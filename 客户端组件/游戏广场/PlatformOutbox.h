...
class CPlatformOutbox : public CDialog
{
	DECLARE_DYNAMIC(CPlatformOutbox)

public:
	CPlatformOutbox(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CPlatformOutbox();

// 对话框数据
	enum { IDD = IDD_DLG_PLATFORM_OUTBOX };
