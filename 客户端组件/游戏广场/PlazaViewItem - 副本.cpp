...
#define GAME_SERVER_ITEM_CX			230									//房间宽度
#define GAME_SERVER_ITEM_CY			240									//房间高度
	...
	case VIEW_MODE_SERVER:	//房间视图
		{
			...
			//进入房间
			CRect rcEnterServer(7,200,178,260);
...
//		m_ImageServer.DrawImage(pDC,nXPos,nYPos,GAME_SERVER_ITEM_CX,GAME_SERVER_ITEM_CY,0,0,SizeImage.cx,SizeImage.cy);
	...
	CRect rcServerScore(nXPos+78,	nYPos+100,nXPos+168,nYPos+120);
	CRect rcMinServerScore(nXPos+78,nYPos+135,nXPos+168,nYPos+155);
	CRect rcServerName(nXPos+22,	nYPos+175,nXPos+168,nYPos+195);
