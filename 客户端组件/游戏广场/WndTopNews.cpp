...
INT CWndTopNews::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	//http://192.168.0.105/WinFromBanner/winlottery.aspx
	IniData.ReadEncryptString(TEXT("PlazaUrl"),TEXT("PlazaTopLot"),TEXT(""),szTodayURL,CountArray(szTodayURL));

	CString strURL = szTodayURL;
	if(!strURL.IsEmpty())
	{
