...
echo 目标客户端资源路径
set dstClientDebug=%prevPath%VC8运行\ClientDebugUnicode
echo %dstClientDebug%
set dstClientRelease=%prevPath%VC8运行\ClientReleaseUnicode
...
echo 目标服务端资源路径
set dstServerDebug=%prevPath%VC8运行\ServDebugUnicode
set dstServerRelease=%prevPath%VC8运行\ServReleaseUnicode
